...
do_recovery_ext4() {
    ...
    cp ${DEPLOY_DIR_IMAGE}/${IMAGE_BASENAME}/${OVERLAYIMAGE_TARGET} ${OTA_TARGET_IMAGE_ROOTFS_EXT4}/IMAGES/userdata.img
    cp ${DEPLOY_DIR_IMAGE}/${IMAGE_BASENAME}/${OVERLAYIMAGE_MAP_TARGET} ${OTA_TARGET_IMAGE_ROOTFS_EXT4}/IMAGES/userdata.map
